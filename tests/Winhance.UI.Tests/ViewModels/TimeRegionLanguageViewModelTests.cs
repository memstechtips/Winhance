...
public class TimeRegionLanguageViewModelTests
{
    ...
    public TimeRegionLanguageViewModelTests()
    {
    ...
    private TimeRegionLanguageViewModel CreateViewModel()
    {
        return new TimeRegionLanguageViewModel(
    ...
    [Fact]
    public void ModuleId_ReturnsTimeRegionLanguage()
    {
        var vm = CreateViewModel();

        vm.ModuleId.Should().Be(FeatureIds.TimeRegionLanguage);
    }

    [Fact]
    public void DisplayName_ReturnsLocalizedTimeRegionLanguageName()
    {
        _mockLocalizationService
            .Setup(l => l.GetString("Feature_TimeRegionLanguage_Name"))
            .Returns("Time, region and language");

        var vm = CreateViewModel();

        vm.DisplayName.Should().Be("Time, region and language");
    }
    ...
    public void ApplySearchFilter_SetsSearchText()
    {
        ...
        vm.ApplySearchFilter("time, region and language");

        vm.SearchText.Should().Be("time, region and language");
    }
