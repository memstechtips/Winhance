...
public partial class TimeRegionLanguageViewModel : BaseSettingsFeatureViewModel, ICustomizationFeatureViewModel
{
    public TimeRegionLanguageViewModel(
    ...
    public override string ModuleId => FeatureIds.TimeRegionLanguage;

    protected override string GetDisplayNameKey() => "Feature_TimeRegionLanguage_Name";
}
