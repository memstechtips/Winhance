...
// One object so that leaving review is one assignment to null: with separate properties reset by a
// ClearReviewState(), a new one is one forgotten line away from leaking into the next mode. Mutable and
