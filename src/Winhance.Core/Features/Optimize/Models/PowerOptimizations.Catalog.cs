...
{
    /// <summary>
    /// Power settings catalog definitions - contains all power setting subgroups and their settings.
    /// </summary>
    public static partial class PowerOptimizations
    {
        /// <summary>
        /// Gets the primary power settings for the main UI (non-advanced settings).
        /// These are the settings that should be shown in the main power optimization view.
        /// </summary>
        public static List<PowerSettingDefinition> GetPrimaryPowerSettings()
        {
            var primarySettings = new List<PowerSettingDefinition>();

            // Turn off the display (Combobox with time intervals)
            primarySettings.Add(new PowerSettingDefinition
            {
                Guid = "3c0bc021-c8a8-4e07-a973-6b14cbcb2b7e",
                Alias = "monitor-timeout-main",
                DisplayName = "Turn off the display",
                Description = "Specifies the period of inactivity before Windows turns off the display.",
                SubgroupGuid = "primary-settings",
                MinValue = 0,
                MaxValue = 300,
                Increment = 1,
                Units = "Minutes",
        ...
        /// Note: Power Plan Selection is handled separately in the main UI, not as an advanced setting.
        /// </summary>
        public static List<PowerSettingSubgroup> GetAllSubgroups()
        {
            var subgroups = new List<PowerSettingSubgroup>
            {
                // Removed GetPowerPlanSelectionSubgroup() - Power Plan selection is handled in main UI
                GetHardDiskSubgroup(),
                ...
                GetPowerButtonsSubgroup(), // Only show if system has buttons/lid
                GetBatterySubgroup(),      // Only show if system has battery
        ...
        /// <summary>
        /// NOTE: Power Plan Selection is now handled separately in the main UI, not as an advanced setting.
        /// This method is kept for reference but is no longer used in GetAllSubgroups().
        /// </summary>
        [Obsolete("Power Plan Selection is now handled in the main UI, not in advanced settings")]
        private static PowerSettingSubgroup GetPowerPlanSelectionSubgroup()
        {
            ...
            var powerPlanSelection = new PowerSettingDefinition
            {
                Guid = "active-power-plan",
                Alias = "activeplan",
                ...
                CustomCommandValueMap = new Dictionary<int, string>
                {
                    ...
                    { 2, "e9a42b02-d5df-448d-aa00-03f14749eb61" }, // Ultimate Performance (fallback to standard)
                },
                PossibleValues = new List<PowerSettingValue>
                {
                    new PowerSettingValue { Index = 0, FriendlyName = "Balanced" },
                    new PowerSettingValue { Index = 1, FriendlyName = "High Performance" },
                    new PowerSettingValue { Index = 2, FriendlyName = "Ultimate Performance" },
                },
            };

            subgroup.Settings.Add(powerPlanSelection);
            return subgroup;
        }
        ...
        private static PowerSettingSubgroup GetHardDiskSubgroup()
        {
            ...
            // Turn off hard disk after - NumericUpDown control for advanced settings
        ...
        private static PowerSettingSubgroup GetSleepSubgroup()
        {
            ...
            // Sleep after - NumericUpDown control (same setting as "Put the computer to sleep" but with NumericUpDown)
            var sleepAfter = new PowerSettingDefinition
            {
                Guid = "29f6c1db-86da-48c5-9fdb-f2b67b1f44da",
                Alias = "standbyidle",
                DisplayName = "Sleep after",
                Description = "Specifies the period of inactivity before Windows puts the computer to sleep.",
                SubgroupGuid = subgroup.Guid,
                MinValue = 0,
                MaxValue = 1200,
            ...
            // Allow wake timers - Enum setting
            var allowWakeTimers = new PowerSettingDefinition
            {
                ...
                PossibleValues = new List<PowerSettingValue>
                {
                    ...
                    new PowerSettingValue { Index = 2, FriendlyName = "Important Wake Timers Only" },
                },
            };

            // Enable/Disable Hibernation - Custom command
            var enableHibernation = new PowerSettingDefinition
            {
                Guid = "9d82f7ff-0cf2-4fe3-9c7c-4d3320f8d9f1",
                Alias = "hibernation",
                ...
                CustomCommand = true,
                CustomCommandTemplate = "powercfg /hibernate {0}",
                CustomCommandValueMap = new Dictionary<int, string>
                {
                    { 0, "off" },
                    { 1, "on" },
        ...
        private static PowerSettingSubgroup GetPowerButtonsSubgroup()
        {
            ...
            // Power button action - Enum setting
            ...
            // Sleep button action - Enum setting
        ...
        private static PowerSettingSubgroup GetDisplaySubgroup()
        {
            ...
            // Turn off display after - NumericUpDown control for advanced settings
            var turnOffDisplayAfter = new PowerSettingDefinition
            {
                Guid = "3c0bc021-c8a8-4e07-a973-6b14cbcb2b7e",
                Alias = "monitor-timeout",
                DisplayName = "Turn off display after",
                Description = "Specifies the period of inactivity before Windows turns off the display.",
                SubgroupGuid = subgroup.Guid,
                MinValue = 0,
                MaxValue = 1200,
        ...
        private static PowerSettingSubgroup GetProcessorPowerManagementSubgroup()
        {
            ...
            // Minimum processor state - Percentage setting
        ...
        private static PowerSettingSubgroup GetBatterySubgroup()
        {
            ...
            // Critical battery action - Enum setting
            ...
            // Low battery level - Percentage setting
        ...
        private static PowerSettingSubgroup GetDesktopBackgroundSettingsSubgroup()
        {
            ...
            var slideshow = new PowerSettingDefinition
            {
                ...
                PossibleValues = new List<PowerSettingValue>
                {
                    ...
                    new PowerSettingValue { Index = 1, FriendlyName = "Paused" },
                },
            };
        ...
        private static PowerSettingSubgroup GetMultimediaSettingsSubgroup()
        {
            ...
            var whenSharingMedia = new PowerSettingDefinition
            {
                ...
                PossibleValues = new List<PowerSettingValue>
                {
                    ...
                    new PowerSettingValue { Index = 2, FriendlyName = "Allow the computer to enter Away Mode" },
                },
            };
            ...
            var videoPlaybackQualityBias = new PowerSettingDefinition
            {
                ...
                PossibleValues = new List<PowerSettingValue>
                {
                    ...
                    new PowerSettingValue { Index = 1, FriendlyName = "Video playback performance bias" },
                },
            };
