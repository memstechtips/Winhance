...
namespace Winhance.Core.Features.Common.Interfaces
{
    ...
    public interface ITooltipDataService
    {
        ...
        Task<Dictionary<string, SettingTooltipData>> GetTooltipDataAsync(IEnumerable<ApplicationSetting> settings);
        ...
        Task<SettingTooltipData?> RefreshTooltipDataAsync(string settingId, ApplicationSetting setting);
        ...
        Task<Dictionary<string, SettingTooltipData>> RefreshMultipleTooltipDataAsync(IEnumerable<ApplicationSetting> settings);
    }
}
