...
/// <summary>How a setting is RENDERED (a presentation concern, not an engine one). Authored from the old
/// InputType during the SettingDefinition retirement; the engine resolves state from shape (Numeric/States/
