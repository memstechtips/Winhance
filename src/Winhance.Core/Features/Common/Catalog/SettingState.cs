...
/// <see cref="Effects"/> ride along on apply only (design §2.2).</summary>
public sealed record SettingState
{
    ...
    /// Phase 4). A fallback state may still carry a <c>Set</c> (its representative known value); if that Set
