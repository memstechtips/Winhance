...
namespace Winhance.WPF.Features.Customize.ViewModels
{
    ...
    /// </summary>
    public partial class ExplorerCustomizationsViewModel : BaseCustomizationsViewModel
    {
        /// <summary>
        ...
        /// </summary>
        public override string CategoryName => "Explorer";
        ...
        public override async Task LoadSettingsAsync()
        {
            ...
            {
                _logService.Log(LogLevel.Error, $"Error loading Explorer customizations: {ex.Message}");
            }
            finally
            {
                IsLoading = false;
        ...
        /// <summary>
        /// Initializes the Explorer customization actions.
        /// </summary>
        private void InitializeActions()
        {
            Actions.Clear();

            // Explorer actions are intentionally left empty
        }
        ...
        /// <summary>
        /// Applies all selected Explorer customizations.
        /// </summary>
        ...
        public override async Task ApplySettingsAsync(IProgress<TaskProgressDetail> progress)
        {
            ...
            {
                _logService.Log(LogLevel.Error, $"Error applying Explorer customizations: {ex.Message}");
                throw;
            }
        }

        /// <summary>
        /// Restores all selected Explorer customizations to their default values.
        /// </summary>
        /// <param name="progress">The progress reporter.</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        public override async Task RestoreDefaultsAsync(IProgress<TaskProgressDetail> progress)
        {
            ...
            {
                _logService.Log(LogLevel.Error, $"Error restoring Explorer customizations: {ex.Message}");
                throw;
            }
        }
