        ...
        )
        {
            ...
            try
            {
                object viewModel = feature.ViewModelTypeName switch
                {
                    ...
                    "PrivacyOptimizationsViewModel" => serviceProvider.GetRequiredService<PrivacyOptimizationsViewModel>(),
                    "WindowsSecurityOptimizationsViewModel" => serviceProvider.GetRequiredService<WindowsSecurityOptimizationsViewModel>(),
                    "GamingandPerformanceOptimizationsViewModel" => serviceProvider.GetRequiredService<GamingandPerformanceOptimizationsViewModel>(),
                    "ExplorerOptimizationsViewModel" => serviceProvider.GetRequiredService<ExplorerOptimizationsViewModel>(),
                ...
                UserControl view = feature.ViewModelTypeName switch
                {
                    ...
                    "PrivacyOptimizationsViewModel" => serviceProvider.GetRequiredService<PrivacyOptimizationsView>(),
                    "WindowsSecurityOptimizationsViewModel" => serviceProvider.GetRequiredService<WindowsSecurityOptimizationsView>(),
                    "GamingandPerformanceOptimizationsViewModel" => serviceProvider.GetRequiredService<GamingandPerformanceOptimizationsView>(),
                    "ExplorerOptimizationsViewModel" => serviceProvider.GetRequiredService<ExplorerOptimizationsView>(),
